...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", default=os.environ.get("CHURNGUARD_MODEL_PATH", "models/best_model.pkl"))
    parser.add_argument("--model-name", default=os.environ.get("MODEL_NAME", "churn_model_v1"))
